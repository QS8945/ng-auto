...
// 本地开发
gulp.task('default', ['styles','inject', 'browserSync', 'watch']);
// 线上环境打包
gulp.task('dist', ['clean'], function() {
	runSequence('inject', 'build', 'browserSyncDist');
});